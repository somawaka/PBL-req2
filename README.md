...
| `handoff/req3/` | Req③へ渡す候補スキーマ、サンプル、Run Manifest |
...
候補カラム、少数の出力例、Run Manifestの暫定仕様は [handoff/req3/](handoff/req3/) を参照してください。完全なAPI実行結果ではなく、Req③の入力設計とGem試作に使うためのインターフェース例です。
